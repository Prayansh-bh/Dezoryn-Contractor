export const DEFAULT_PRODUCTS = [
    {
        ...
        description: "Hot-applied road marking compound developed for sharp lines, dependable adhesion and long service life under heavy traffic.",
        features: [
    ...
    },
    {
        ...
        description: "Precision-graded drop-on and intermix glass beads that return headlight illumination to drivers for safer night-time navigation.",
        features: [
    ...
    },
    {
        ...
        description: "Durable coatings for concrete kerbs, medians and metal barriers, developed to retain visual clarity across demanding outdoor conditions.",
        features: [
            "Weather resistant",
    ...
    },
    {
        ...
        description: "High-impact road guidance products for curves, medians and lane boundaries where dependable visibility and clear direction matter.",
        features: [
    ...
    },
    {
        ...
        description: "A coordinated range of cones, bollards, barricades and reflectors for highway projects, diversions and active construction zones.",
        features: [
    ...
    },
    {
        ...
        description: "Specification-led production, packaging and dispatch planning for contractors whose project requirements do not fit an off-the-shelf order.",
        features: [
            "Requirement review",
